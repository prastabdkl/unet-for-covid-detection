...
def testGenerator(test_path,num_image = 10,target_size = (512,512),flag_multi_class = False,as_gray = True):
...
def saveResult(save_path,results):
    for i in range(10):
        plt.imsave(os.path.join(save_path,'%d_predict.jpg'%i),results[i,:,:,0],cmap="gray")
